...
#+begin_src emacs-lisp
  ...
  (defvar-keymap mish/toggle-keymap
    "t" #'consult-theme
    "s" #'hydra-text-scale/body
    "d" #'ediff
    )

  (defvar-keymap mish/insert-keymap
    "s" #'org-insert-structure-template
    )

  (defvar-keymap mish/error-keymap
    "/" #'consult-flymake
    "c" #'consult-compile-error
    )

  (defvar-keymap mish/edit-keymap
    "t" #'transpose-words
    )

  (defvar-keymap mish/rings-and-regs-keymap
  ...
  (defvar-keymap mish/buffer-keymap
  ...
  (defvar-keymap mish/window-keymap
    "k" #'evil-window-up
    "j" #'evil-window-down
    "h" #'evil-window-left
    "l" #'evil-window-right
  ...
  (defvar-keymap mish/project-keymap
    "b" #'projectile-switch-to-buffer
    "/" #'projectile-switch-project
    "s" #'projectile-find-related-file
    ) 

  (defvar-keymap mish/file-keymap
    "p" #'mish/open-personal-config-dir
  ...
  (defvar-keymap mish/lsp-code-keymap
    "d" #'lsp-find-definition 
   ) 
...
#+begin_src emacs-lisp
	...
	"f" mish/file-keymap
	"p" mish/project-keymap
	"w" mish/window-keymap
	"b" mish/buffer-keymap
	"r" mish/rings-and-regs-keymap
	"e" mish/edit-keymap
	"!" mish/error-keymap
	"i" mish/insert-keymap
	"t" mish/toggle-keymap
	"c" mish/code-keymap
	)


      ;; (evil-define-keymap mish/leader-key-keymap
      ;;   "My custom Evil keymap."
      ;;   :mode evil-mode
      ;;   :local t
      ;;   (kbd " ") mish/leader-keymap
      ;;   )

      ;; (defvar-keymap mish/leader-key-minor-mode-map)
      ;;   (define-minor-mode mish/leader-key-minor-mode
      ;; 	"A mode for my custom keybindings."
      ;; 	:keymap mish/leader-key-minor-mode-map
      ;; 	)
  ;;     (add-hook 'mish/leader-key-minor-mode-hook (lambda () (make-local-variable 'mish/leader-key-minor-mode-map)))
  ;;     (mish/leader-key-minor-mode t)

  (unbind-key "SPC" evil-motion-state-map)
  (bind-key "SPC" mish/leader-keymap evil-motion-state-map)
  (add-hook lsp-mode-hook (lambda () (bind-key "c" mish/lsp-code-keymap mish/leader-keymap)))
