...
#+begin_src emacs-lisp
  ...
  ;; Remap evil-yank to my-evil-yank
  ...
  ;; (defun my/evil-visual-paste-move-point-back-first (orig-fun &rest args)
  ;;   "make sure visual paste doesn't delete an extra character in front when `my/evil-dont-move-cursor-or-unhighlight-advice` is on evil-yank"
  ...
  ;; (advice-add 'evil-visual-paste :around #'my/evil-visual-paste-move-point-back-first)
